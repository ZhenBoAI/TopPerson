# Richard Feynman Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns Richard Feynman's recurring method into a reusable cognitive operating system.

Core direction:

- Richard Feynman style advice for learning, genuine understanding, explanation, and curiosity
...
- `voice-mode`: default is analysis; add light Richard Feynman tone only if explicitly requested

Direct example:

```text
Use $richard-feynman-skill to analyze this situation with the method of Richard Feynman and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond Richard Feynman's strongest documented range, the skill should say so
