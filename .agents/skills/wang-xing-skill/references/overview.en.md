...
This skill is not a quote dump or exaggerated roleplay. It turns 王兴's recurring method into a reusable cognitive operating system.

Core direction:

- Wang Xing style advice for competitive judgment, strategic focus, and organizational scaling
...
- `voice-mode`: default is analysis; add light 王兴 tone only if explicitly requested

Direct example:

```text
Use $wang-xing-skill to analyze this situation with the method of 王兴 and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond 王兴's strongest documented range, the skill should say so
