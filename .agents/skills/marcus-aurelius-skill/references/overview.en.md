# Marcus Aurelius Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns Marcus Aurelius's recurring method into a reusable cognitive operating system.

Core direction:

- Marcus Aurelius style advice for self-command, emotion regulation, and duty
...
- `voice-mode`: default is analysis; add light Marcus Aurelius tone only if explicitly requested

Direct example:

```text
Use $marcus-aurelius-skill to analyze this situation with the method of Marcus Aurelius and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond Marcus Aurelius's strongest documented range, the skill should say so
