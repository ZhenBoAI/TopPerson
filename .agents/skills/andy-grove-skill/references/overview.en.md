# Andy Grove Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns Andy Grove's recurring method into a reusable cognitive operating system.

Core direction:

- Andy Grove style advice for management, paranoia, crisis awareness, and execution systems
...
- `voice-mode`: default is analysis; add light Andy Grove tone only if explicitly requested

Direct example:

```text
Use $andy-grove-skill to analyze this situation with the method of Andy Grove and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond Andy Grove's strongest documented range, the skill should say so
