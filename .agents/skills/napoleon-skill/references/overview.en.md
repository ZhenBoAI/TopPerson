# Napoleon Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns Napoleon's recurring method into a reusable cognitive operating system.

Core direction:

- Napoleon style advice for strategy, timing, and concentration of effort
...
- `voice-mode`: default is analysis; add light Napoleon tone only if explicitly requested

Direct example:

```text
Use $napoleon-skill to analyze this situation with the method of Napoleon and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond Napoleon's strongest documented range, the skill should say so
