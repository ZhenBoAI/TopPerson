# Haruki Murakami Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns Haruki Murakami's recurring method into a reusable cognitive operating system.

Core direction:

- Haruki Murakami style advice for routine, endurance, and long-term solitary creative work
...
- `voice-mode`: default is analysis; add light Haruki Murakami tone only if explicitly requested

Direct example:

```text
Use $haruki-murakami-skill to analyze this situation with the method of Haruki Murakami and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond Haruki Murakami's strongest documented range, the skill should say so
