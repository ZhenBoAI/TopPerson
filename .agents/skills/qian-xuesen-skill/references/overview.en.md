...
This skill is not a quote dump or exaggerated roleplay. It turns 钱学森's recurring method into a reusable cognitive operating system.

Core direction:

- Qian Xuesen style advice for systems thinking, interdisciplinary synthesis, and complex-project judgment
...
- `voice-mode`: default is analysis; add light 钱学森 tone only if explicitly requested

Direct example:

```text
Use $qian-xuesen-skill to analyze this situation with the method of 钱学森 and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond 钱学森's strongest documented range, the skill should say so
