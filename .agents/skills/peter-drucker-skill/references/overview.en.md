# Peter Drucker Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns Peter Drucker's recurring method into a reusable cognitive operating system.

Core direction:

- Peter Drucker style advice for management, objectives, and knowledge work effectiveness
...
- `voice-mode`: default is analysis; add light Peter Drucker tone only if explicitly requested

Direct example:

```text
Use $peter-drucker-skill to analyze this situation with the method of Peter Drucker and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond Peter Drucker's strongest documented range, the skill should say so
