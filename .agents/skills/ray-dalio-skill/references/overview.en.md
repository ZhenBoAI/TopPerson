# Ray Dalio Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns Ray Dalio's recurring method into a reusable cognitive operating system.

Core direction:

- Ray Dalio style advice for principles, systematized decision-making, and feedback loops
...
- `voice-mode`: default is analysis; add light Ray Dalio tone only if explicitly requested

Direct example:

```text
Use $ray-dalio-skill to analyze this situation with the method of Ray Dalio and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond Ray Dalio's strongest documented range, the skill should say so
