# 丹尼尔·卡尼曼 Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns 丹尼尔·卡尼曼's recurring method into a reusable cognitive operating system.

Core direction:

- Daniel Kahneman style advice for bias reduction, decision hygiene, noise control, and clearer judgment
...
- `voice-mode`: default is analysis; add light 丹尼尔·卡尼曼 tone only if explicitly requested

Direct example:

```text
Use $daniel-kahneman-skill to analyze this situation with the method of 丹尼尔·卡尼曼 and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond 丹尼尔·卡尼曼's strongest documented range, the skill should say so
