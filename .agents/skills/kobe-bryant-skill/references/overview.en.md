# Kobe Bryant Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns Kobe Bryant's recurring method into a reusable cognitive operating system.

Core direction:

- Kobe Bryant style advice for discipline, deliberate practice, and competitive standards
...
- `voice-mode`: default is analysis; add light Kobe Bryant tone only if explicitly requested

Direct example:

```text
Use $kobe-bryant-skill to analyze this situation with the method of Kobe Bryant and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond Kobe Bryant's strongest documented range, the skill should say so
