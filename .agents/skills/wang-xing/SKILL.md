---
name: wang-xing
description: 基于王兴的公开演讲、访谈、公开材料与可信研究，按王兴式的竞争判断、战略聚焦、组织扩张框架分析现实问题并给出行动建议。Use when Codex needs Wang Xing style advice for competitive judgment, strategic focus, and organizational scaling.
---
