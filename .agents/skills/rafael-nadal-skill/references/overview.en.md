# Rafael Nadal Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns Rafael Nadal's recurring method into a reusable cognitive operating system.

Core direction:

- Rafael Nadal style advice for consistency, resilience, and low-error execution
...
- `voice-mode`: default is analysis; add light Rafael Nadal tone only if explicitly requested

Direct example:

```text
Use $rafael-nadal-skill to analyze this situation with the method of Rafael Nadal and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond Rafael Nadal's strongest documented range, the skill should say so
