...
This skill is not a quote dump or exaggerated roleplay. It turns 曹操's recurring method into a reusable cognitive operating system.

Core direction:

- Cao Cao style advice for strategy, talent use, and realism under pressure
...
- `voice-mode`: default is analysis; add light 曹操 tone only if explicitly requested

Direct example:

```text
Use $cao-cao-skill to analyze this situation with the method of 曹操 and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond 曹操's strongest documented range, the skill should say so
