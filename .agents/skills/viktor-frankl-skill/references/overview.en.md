# 维克多·弗兰克尔 Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns 维克多·弗兰克尔's recurring method into a reusable cognitive operating system.

Core direction:

- Viktor Frankl style advice for meaning, agency, resilience, and choosing one's response under pressure
...
- `voice-mode`: default is analysis; add light 维克多·弗兰克尔 tone only if explicitly requested

Direct example:

```text
Use $viktor-frankl-skill to analyze this situation with the method of 维克多·弗兰克尔 and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond 维克多·弗兰克尔's strongest documented range, the skill should say so
