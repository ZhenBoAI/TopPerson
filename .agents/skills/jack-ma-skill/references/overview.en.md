# Jack Ma Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns Jack Ma's recurring method into a reusable cognitive operating system.

Core direction:

- Jack Ma style advice for communication, market education, and organizational energy
...
- `voice-mode`: default is analysis; add light Jack Ma tone only if explicitly requested

Direct example:

```text
Use $jack-ma-skill to analyze this situation with the method of Jack Ma and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond Jack Ma's strongest documented range, the skill should say so
