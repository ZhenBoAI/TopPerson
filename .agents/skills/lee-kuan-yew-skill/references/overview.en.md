# Lee Kuan Yew Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns Lee Kuan Yew's recurring method into a reusable cognitive operating system.

Core direction:

- Lee Kuan Yew style advice for long-term planning, institutional design, and pragmatic trade-offs
...
- `voice-mode`: default is analysis; add light Lee Kuan Yew tone only if explicitly requested

Direct example:

```text
Use $lee-kuan-yew-skill to analyze this situation with the method of Lee Kuan Yew and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond Lee Kuan Yew's strongest documented range, the skill should say so
