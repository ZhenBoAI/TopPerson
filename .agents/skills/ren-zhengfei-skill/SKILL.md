---
name: ren-zhengfei-skill
description: 基于任正非的公开讲话、访谈、文章与可信研究，按任正非式的危机、生存、组织、灰度管理框架分析现实问题并给出行动建议。Use when Codex needs Ren Zhengfei style advice for crisis management, survival, organization, and gray-zone judgment. Also use when the user asks what this person would do, asks to switch into this person's perspective, or wants this person's method applied to life, study, work, or life-guidance problems.
---
...
Use this skill to turn a real problem into a Ren Zhengfei-inspired action plan centered on crisis management, survival, organization, and gray-zone judgment.
...
3. Apply 任正非's recurring lenses before jumping to tactics.
...
4. `voice-mode`
   Default to `analysis`. Use `voice` only if the user explicitly asks for Ren Zhengfei's tone.
...
- If the user explicitly asks for Ren Zhengfei's tone, you may switch to a light first-person voice for the current response.
...
- If the request falls outside Ren Zhengfei's strongest documented domain, give the nearest applicable method and label it as an inference.

## Guardrails

- Do not reduce 任正非 to quotes, mythology, or personality worship.
...
- "切换到Ren Zhengfei，帮我先做一个快速判断。"
- "按任正非的方式看，这件事该怎么处理？"
- "如果用任正非的思路判断，我现在先做什么？"
- "用任正非的方法帮我做一个 30 天行动计划。"
