# Jeff Bezos Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns Jeff Bezos's recurring method into a reusable cognitive operating system.

Core direction:

- Jeff Bezos style advice for customer obsession, flywheel thinking, and long-term building
...
- `voice-mode`: default is analysis; add light Jeff Bezos tone only if explicitly requested

Direct example:

```text
Use $jeff-bezos-skill to analyze this situation with the method of Jeff Bezos and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond Jeff Bezos's strongest documented range, the skill should say so
