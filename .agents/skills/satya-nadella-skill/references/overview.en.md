# 萨提亚·纳德拉 Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns 萨提亚·纳德拉's recurring method into a reusable cognitive operating system.

Core direction:

- Satya Nadella style advice for empathy, learning culture, strategic renewal, and leading change without losing standards
...
- `voice-mode`: default is analysis; add light 萨提亚·纳德拉 tone only if explicitly requested

Direct example:

```text
Use $satya-nadella-skill to analyze this situation with the method of 萨提亚·纳德拉 and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond 萨提亚·纳德拉's strongest documented range, the skill should say so
