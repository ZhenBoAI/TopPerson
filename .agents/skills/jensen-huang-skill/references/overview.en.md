# Jensen Huang Skill Overview

## What This Skill Is For

This skill is not a quote dump or exaggerated roleplay. It turns Jensen Huang's recurring method into a reusable cognitive operating system.

Core direction:

- Jensen Huang style advice for long-term R&D, technical strategy, and founder leadership
...
- `voice-mode`: default is analysis; add light Jensen Huang tone only if explicitly requested

Direct example:

```text
Use $jensen-huang-skill to analyze this situation with the method of Jensen Huang and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond Jensen Huang's strongest documented range, the skill should say so
