...
This skill is not a quote dump or exaggerated roleplay. It turns 马化腾's recurring method into a reusable cognitive operating system.

Core direction:

- Pony Ma style advice for product restraint, pacing, platform judgment, and long-cycle building
...
- `voice-mode`: default is analysis; add light 马化腾 tone only if explicitly requested

Direct example:

```text
Use $ma-huateng-skill to analyze this situation with the method of 马化腾 and give me a practical plan.
```

## Usage Notes

- Default to modern, clear, practical analysis instead of heavy roleplay
- If the request goes beyond 马化腾's strongest documented range, the skill should say so
